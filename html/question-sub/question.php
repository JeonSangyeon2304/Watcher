...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/freeboard.css?ver=2">
	<link rel="stylesheet" type="text/css" href="../css/question.css?ver=2">
</head>
<body>
<div class="frame">
...
<?php
		...
		<div class="contents freeboard-contents">
				<div class="add-box">
					<button class="add-box-btn">내질문</button>
					<a href="question-write.php" style="width:70px">
						<button class="add-box-btn long-add-box-btn">질문하기</button>
					</a>
				...
				<table class="table-freeboard">
					...
					<?php
						$resource = mysql_query("select * from q_and_a");
						...
						if(isset($_GET[idx]) ){
							...
							$sql = "select * from q_and_a order by no desc limit $start, 10";
						} else {
							$sql = "select * from q_and_a order by no desc limit 10";
						}
						...
						while($row = mysql_fetch_assoc($resource)){
							print "<tr>";
							echo "<th> $num </th>";
							print "<td> $row[q_title]</td>";
							print "<td> $row[q_user_id]</td>";
							print "<td> $row[q_write_time]</td>";
							print "</tr>";
						...
						for($i=0; $i<$count; $i++){
							print "<a href=http://14.49.39.164/question-sub/question.php?idx={$i} class=nav-link>";
							$j = $i + 1;
							print "{$j}";
							print "</a>&nbsp;&nbsp;";
						}
